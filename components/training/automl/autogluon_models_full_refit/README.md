...
identified by model_name, on the complete training dataset. The refitting process retrains the model architecture on the
full data, typically improving performance compared to models trained on sampled data.
...
confusion matrix are written under model_artifact.path / model_name_FULL / metrics.
