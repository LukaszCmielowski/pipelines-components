...
def notebook_generation(
  ...
  {'cell_type': 'markdown',
   ...
   'metadata': {},
   'source': ['<a id="experiment-run-details"></a>\n',
  ...
  {'cell_type': 'markdown',
   ...
   'metadata': {},
   'source': ['<a id="experiment-leaderboard"></a>\n',
  ...
  {'cell_type': 'markdown',
   ...
   'metadata': {},
   'source': ['<a id="download-trained-model"></a>\n',
    '## Download trained model\n',
    '\n',
    '**Tip:** IF you want to download different model than the best one set `model_name` accordingly (must match a name from the leaderboard **model** column).']},
  {'cell_type': 'code',
   'execution_count': None,
  ...
  {'cell_type': 'code',
   ...
   'metadata': {},
   'outputs': [],
   'source': ['full_refit_prefix = os.path.join(pipeline_name, run_id, "autogluon-models-full-refit")\n',
  ...
  {'cell_type': 'markdown',
   ...
   'metadata': {},
   'source': ['<a id="load-the-predictor"></a>\n',
    '## Load the predictor\n',
    '\n',
  ...
  {'cell_type': 'markdown',
   ...
   'metadata': {},
   'source': ['<a id="predict-the-values"></a>\n',
    '## Predict the values\n',
    '\n',
  ...
  {'cell_type': 'markdown',
   ...
   'metadata': {},
   'source': ['<a id="summary-and-next-steps"></a>\n',
  ...
  {'cell_type': 'markdown',
   ...
   'metadata': {},
   'source': ['---']}],
 'metadata': {'kernelspec': {'display_name': 'Python 3.12',
   'language': 'python',
   'name': 'python3'},
